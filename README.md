...
## Разработка
Проект полностью мигрировал на **Feature-Sliced Design (FSD)**. Все компоненты изолированы в слое `widgets`, а общая логика и UI-элементы вынесены в `shared`. Использование CSS Modules гарантирует отсутствие конфликтов стилей.
